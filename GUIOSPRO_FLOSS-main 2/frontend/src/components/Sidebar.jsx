    ...
    <aside className="sidebar">
      <div className="sidebar-logo">
        <svg className="sidebar-icon" viewBox="0 0 28 28" fill="none">
          <rect width="28" height="28" rx="7" fill="#6366f1" fillOpacity="0.15"/>
          <path d="M7 14h4m0 0l3-5 3 8 3-5h3" stroke="#6366f1" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
